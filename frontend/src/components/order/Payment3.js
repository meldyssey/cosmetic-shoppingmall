                ...
                <div className={styles.orderFin}>
                    ...
                    <div className={styles.notice}>
                        <p>
                            ...
                            <br />
                            주문하신 제품은 결제완료 시점으로부터 영업일 기준
                            3일 내에 받아보실 수 있습니다.
                            <br />
                            단, 도서 지역 및 섬 지역은 지연 될 수 있으며 명절 및
                            연말이나 주문 폭주 시 또한 지연 될 수 있습니다.
                            <br />
                            <br />
                            주문이 완료되었다고 해도 재고부족 등의 이유로 주문
                            취소가 될 수 있으니 이점 양해 부탁드립니다.
                            <br />조 말론 런던 온라인 부티크에서는 이용자가 구매
                            신청한 제품 등이 품절 등의 사유로
                            <br />
                            인도 또는 제공을 할 수 없을 때에는 그 사유를
                            이용자에게 통지하고
                            <br />
                            사전에 제품 등의 대금을 받은 경우에는 환급하거나
                            환급에 필요한 조치를 취합니다.
                        </p>
                    </div>
